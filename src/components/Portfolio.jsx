        ...
        {projectData.map((item, index) => {
          return (
            <Div key={index} className="flex flex-col gap-4 cursor-pointer">
              ...
              <div className="text-[20px] gap-10 2xl:text-[24px] text-[#CCCCCC] text-center">
                {item.name}
                <div className="text-[13px] mt-3 ">
                    <a href={item.git}>
                  <button className=" p-2 cursor-pointer hover:text-gray-100 rounded-md flex-col items-center justify-center gap-x-1 text-center border border-green-500 py-1 px-4 bg-green-500 hover:bg-green-600 active:bg-green-700 text-white">GitHub</button></a>
                  <a href={item.url}>
                  <button className=" p-2 ml-3  cursor-pointer hover:text-gray-100 rounded-md flex-col items-center justify-center gap-x-1 text-center border border-green-500 py-1 px-4 bg-green-500 hover:bg-green-600 active:bg-green-700 text-white">Live</button></a>
                </div>
              </div>
            </Div>
          );
